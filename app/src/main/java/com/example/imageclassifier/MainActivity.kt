...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val localModel = LocalModel.Builder()
            .setAssetFilePath("model.tflite") // Asegúrate de que el archivo se llame así en la carpeta assets
            .build()
        ...
        btn.setOnClickListener {
            ...
            val options = CustomImageLabelerOptions.Builder(localModel)
                .setConfidenceThreshold(0.7f) // Umbral de confianza
                .setMaxResultCount(5)         // Máximo número de resultados
                .build()
